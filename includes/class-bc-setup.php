...
class BC_Setup {
	...
	public static function preload_params() {
		...
		$params['defaultAccount']   = ! empty( $defaultAccount['hash'] ) ? $defaultAccount['hash'] : null;
		$params['defaultAccountId'] = ! empty( $defaultAccount['account_id'] ) ? $defaultAccount['account_id'] : null;
