...
class BC_Setup {
	...
	public static function preload_params() {
		...
		$params['defaultAccount']   = isset( $defaultAccount['hash'] ) ? $defaultAccount['hash'] : null;
		$params['defaultAccountId'] = isset( $defaultAccount['account_id'] ) ? $defaultAccount['account_id'] : null;
